...
def convert_fb15k() -> None:
    ...
    # out_path = pathlib.Path('data/FB15K-237')
    convert_data(path=in_path, file='test')
    convert_data(path=in_path, file='valid', new_file='dev')
    convert_data(path=in_path, file='train')
